        ...
        qDef.getFieldSummaries = function(address) {
            var tag = "qDef.getFieldSummaries",
                ...
                parsePage = function(page) {
					...
					//document.getElementById("name").value  = "Davide";
//			document.getElementById("username").value = "dp3";
//			document.getElementById("password").value = "pass";
//			document.getElementById("email").value = "dav@ped.it";
